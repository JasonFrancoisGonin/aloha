...
import { ClientRegistrationMetadata } from "./oidc-support";

export type ClientRegistrationMetadataRequest = Pick<
  ClientRegistrationMetadata,
  "client_id" | "client_name" | "root_url" | "redirect_uris" | "secret"
>;

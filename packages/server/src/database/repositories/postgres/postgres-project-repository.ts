...
import { ProjectRepository } from "../interfaces/project-repository-interface.js";
import {
  DatabaseProvider,
  PostgreSQLGenericRepository,
} from "./postgres-generic-repository.js";

export class PostgreSQLProjectRepository
  extends PostgreSQLGenericRepository<schemas.Project>

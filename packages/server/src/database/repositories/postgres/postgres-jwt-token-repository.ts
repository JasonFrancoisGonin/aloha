...
import { JWTTokenRepository } from "../interfaces/jwt-token-repository-interface.js";
import {
  DatabaseProvider,
  PostgreSQLGenericRepository,
} from "./postgres-generic-repository.js";

export class PostgreSQLJWTTokenRepository
  extends PostgreSQLGenericRepository<schemas.JWTToken>
  implements JWTTokenRepository
{
  public static inject = [INJECTOR_TOKEN] as const;
  constructor(injector: Injector<DatabaseProvider>) {
    super("jwt_tokens", injector);
  }
}

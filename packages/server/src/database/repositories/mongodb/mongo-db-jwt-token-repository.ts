...
import { JWTTokenRepository } from "../interfaces/jwt-token-repository-interface";
import { Injector, INJECTOR_TOKEN } from "typed-inject";

export class MongoDbJWTTokenRepository
  extends MongoDBGenericRepository<schemas.JWTToken>

...
import { MCPServerOptionsRepository } from "../interfaces/server-options-repository-interface";
...
export class MongoDBMCPServerOptionsRepository
  extends MongoDBVisibilityRepository<schemas.MCPServerOptions>
